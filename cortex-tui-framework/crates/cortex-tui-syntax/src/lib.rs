...
pub use languages::{
    LanguageInfo, LanguageRegistry, extensions_for_language, global_registry,
    is_language_supported, language_from_extension, language_from_path, register_language,
    supported_languages,
};
