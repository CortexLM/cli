...
| `hooks-lifecycle` | `/hooks` — pre_tool / post_tool / on_stop / plugin events | [runtime 120x40](runtime/120x40/hooks-lifecycle.png) | [runtime 40x12](runtime/40x12/hooks-lifecycle.png) |
