...
class CodeBuildPublicSafetyTests(unittest.TestCase):
    ...
    def test_iam_templates_use_placeholders_and_cli_trust_only(self):
        ...
        self.assertNotIn("repo:CortexLM/cli:pull_request", trust_text)
        self.assertNotIn("repo:CortexLM/cli:*", trust_text)
        self.assertIn("job_workflow_ref", trust_text)
        self.assertIn("codebuild.yml@refs/heads/main", trust_text)
    ...
    def test_cloudformation_projects_and_oidc_role(self):
        ...
        self.assertNotIn("repo:${GitHubOrgRepo}:pull_request", self.template)
        self.assertNotIn("repo:${GitHubOrgRepo}:*", self.template)
        self.assertIn("job_workflow_ref", self.template)
    ...
    def test_docs_name_variables_not_secret_values(self):
        ...
        self.assertIn("repo:CortexLM/cli:ref:refs/heads/main", docs)
