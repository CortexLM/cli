...
unique_pngs "$output_dir/40x12" 58
unique_pngs "$output_dir/120x40" 110
...
SPEC §7 plus the COR-35 batch: **110** boards at 120×40 and **58** at 40×12. Each filename is one
...
runtime-only COR-18/225/227/228 scenes,
