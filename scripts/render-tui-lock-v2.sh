...
unique_pngs "$output_dir/40x12" 48
unique_pngs "$output_dir/120x40" 95
...
SPEC §7: **95** boards at 120×40 and **48** at 40×12. Each filename is one
...
and runtime-only COR-18/225/227/228 scenes.
